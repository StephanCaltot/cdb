...
public class DaoProperties {
    ...
    public static final String FIND_COMPUTER = "select computer.id, computer.name, computer.introduced, computer.discontinued, computer.company_id, company.name company_name from computer left join company on company.id = computer.company_id where computer.id = ?;";
    ...
    public static final String PAGE_COMPUTER = "select id, name, introduced, discontinued, company_id from computer limit ? offset ?;";
